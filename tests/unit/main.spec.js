...
describe('VueCardCarousel.vue', () => {
  it('No children should be displayed when 0 elements pass through', () => {
    const arrList = []
...
describe('VueCardCarousel.vue', () => {
  it('The number of child components should match the number of passed in elements to the parent', () => {
    const arrList = [1, 2, 3]
    const wrapper = mount(VueCardCarousel, {
      propsData: { elements: arrList }
    })
